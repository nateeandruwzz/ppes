...
const totalItems = computed(() => filteredTopics.value.length)

const paginatedTopics = computed(() => {
    const start = (currentPage.value - 1) * itemsPerPage
    return filteredTopics.value.slice(start, start + itemsPerPage)
})
...
<template>
    <div class="space-y-6">
        ...
        <div class="relative">
            ...
            <input v-model="searchQuery" type="text" placeholder="ค้นหาหัวข้อการประเมิน..."
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-zinc-100">
                        ...
                        <!-- Empty State -->
                        <tr v-else-if="filteredTopics.length === 0">
                            <td colspan="4">
                                <EmptyState />
                            </td>
                        </tr>
                        <!-- Data Rows -->
                        <tr v-else v-for="(item, index) in paginatedTopics" :key="item.id"
                            ...
                            <td class="px-6 py-4 text-sm text-zinc-600 max-w-md truncate">{{ item.description || '-' }}
                            </td>
