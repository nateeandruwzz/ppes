...
export const createEvaluationCommittee = async (req, res) => {
    try {
        const { period_id, evaluatee_id, committee_user_id, role } = req.body;
        const result = await EvaluationCommittee.create(period_id, evaluatee_id, committee_user_id, role || null);
...
export const updateEvaluationCommittee = async (req, res) => {
    try {
        const { period_id, evaluatee_id, committee_user_id, role } = req.body;
        const result = await EvaluationCommittee.update(req.params.id, period_id, evaluatee_id, committee_user_id, role || null);
